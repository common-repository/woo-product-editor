...
include_once('WoocommerceProductEditor_OptionsManager.php');

class WoocommerceProductEditor_InstallIndicator extends WoocommerceProductEditor_OptionsManager {
